...
export const metadata = createMetadata({
  ...
  description:
    "Comprehensive engineering services including design, equipment procurement, professional installation, and maintenance solutions for industrial and commercial projects in Nigeria.",
      ...
      <section className="py-20 bg-gradient-to-br from-accent-500 to-orange-500 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Get a detailed quote for your engineering needs. Our experts are
